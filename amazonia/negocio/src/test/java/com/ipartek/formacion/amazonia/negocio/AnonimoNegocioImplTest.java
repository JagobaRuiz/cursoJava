...
class AnonimoNegocioImplTest {
	...
	static Usuario USUARIO_LOGIN = Usuario.builder().email("jagoba@email.com").password("admin").build();
	static Usuario USUARIO_LOGIN_USUARIO_INCORRECTO = Usuario.builder().email("incorrecto@email.net").password("incorrecta").build();
	static Usuario USUARIO_LOGIN_PASSWORD_INCORRECTO = Usuario.builder().email("jagoba@email.com").password("incorrecta").build();
