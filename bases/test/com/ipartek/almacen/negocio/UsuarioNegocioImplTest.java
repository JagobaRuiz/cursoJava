...
//			.precio(new BigDecimal("50.24")).build();
	...
	private static Usuario usuario1 = Usuario.builder().email("jagoba@email.com").password("admin").nombre("Jagoba")
			.build();
	...
	private static Usuario USUARIO_NUEVO_EMAIL_EXISTENTE = Usuario.builder().email("jagoba@email.com").password("adminAdmin").nombre("Jagobadmin")
			.build();
